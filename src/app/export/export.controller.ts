...
/* @ngInject */
export function ExportController($q, $firebaseArray, $firebaseObject) {
  ...
  function getDBData() {
    return $q(function(resolve, reject) {
      var gamesData = $firebaseArray(_fbRef.child('games'));

      var playersData = $firebaseObject(_fbRef.child('players'));

      var eventsData = $firebaseArray(_fbRef.child('events'));
